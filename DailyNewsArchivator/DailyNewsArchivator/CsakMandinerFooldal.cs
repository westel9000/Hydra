        ...
        public void ArchiveAll()
        {
            ...
            outputText2Log.Add("=========================BEGIN==========================");
                ...
                lock (lockObject)
                {
                    Console.ForegroundColor = ConsoleColor.White;
                    Console.BackgroundColor = ConsoleColor.Blue;
                    Console.Write($" Hiba itt {DateTime.Now.ToString("yyMMdd.HHmm")}: https://mandiner.hu/");
                    Console.ResetColor();
                }
                    Console.Write(Environment.NewLine);
            ...
            System.IO.File.AppendAllLines($"mandiner.hu-fooldal-log-{TimeStamp.Instance.TheTimeStamp}.txt", outputText2Log);
        }
    }
}
