...
namespace DailyNewsArchivatorFramework
{
    ...
    public class Makronom
    {
        public void ArchiveAll(string urlAlapCim)
        {
            ...
            string[] hrefSeparator = { "href=\"" };
            string[] urlCimek = s.Split(hrefSeparator, StringSplitOptions.RemoveEmptyEntries);
            ...
            string[] utmSeparator = { "utm_source=" };
            var valogatottKulsosCimek = from elem in valogatottCimek                                        
                                        where elem.Contains("utm_source=")
                                        select elem.Split(utmSeparator, StringSplitOptions.RemoveEmptyEntries).FirstOrDefault();
