    ...
    public class CsakMoszkvaterFooldal
    {
        ...
        public void ArchiveAll()
        {
            ...
            lock (lockObject)
            {
                ...
                {
                    Console.WriteLine($" Hiba itt {DateTime.Now.ToString("yyMMdd.HHmm")}: https://moszkvater.com/");
            ...
            System.IO.File.WriteAllLines($"moszkvater.com-fooldal-log-{TimeStamp.Instance.TheTimeStamp}.txt", outputText2Log);
        }
    }
}